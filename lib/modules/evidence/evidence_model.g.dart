...
void _expenseEvidenceSerialize(
  ...
  writer.writeDateTime(offsets[4], object.evidenceDate);
...
ExpenseEvidence _expenseEvidenceDeserialize(
  ...
  object.evidenceDate = reader.readDateTime(offsets[4]);
  object.fileName = reader.readStringOrNull(offsets[5]);
  object.id = id;
  object.isDirty = reader.readBool(offsets[6]);
  object.localFilePath = reader.readStringOrNull(offsets[7]);
