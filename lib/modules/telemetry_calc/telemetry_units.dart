...
class UnitCatalog {
  static final Map<String, EngineeringUnit> _units = {
    ...
    'h': EngineeringUnit(
      ...
      label: 'h',
      dimension: QuantityDimension.time,
      toBase: (value) => _scale(value, 3600),
      fromBase: (value) => _unscale(value, 3600),
    ),
    'W': EngineeringUnit(
      id: 'W',
      label: 'W',
      dimension: QuantityDimension.power,
      toBase: (value) => 10 * math.log(value) / math.ln10,
      fromBase: (value) => math.pow(10, value / 10).toDouble(),
    ),
    ...
    'J': EngineeringUnit(
      ...
      label: 'J',
      dimension: QuantityDimension.energy,
      toBase: (value) => _unscale(value, 3600),
      fromBase: (value) => _scale(value, 3600),
    ),
    'm2': const EngineeringUnit(
      id: 'm2',
      label: 'm²',
    ...
    'Ah': const EngineeringUnit(
      id: 'Ah',
      label: 'Ah',
      dimension: QuantityDimension.electricCapacity,
      toBase: _identity,
      fromBase: _identity,
    ),
