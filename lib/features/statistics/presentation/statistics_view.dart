...
class StatisticsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final logic = serviceLocator<StatisticsController>();
...
class _WorkDistribution extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AppCard(
      child: Builder(
        builder: (context) {
          final totalDays = logic.workDays + logic.tripDays + logic.restDays;
          return Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              ...
              Row(
                children: [
                  Expanded(
                    child: _CompactStat(
                      label: "加班小时",
                      value: logic.workHours.toStringAsFixed(1),
        ...
        builder: (context) {
          ...
          return Column(
            ...
            children: [
              ...
              _TotalCostHeader(
                totalCost: totalCost,
                yearlyCost: logic.yearSubCost,
                semantic: semantic,
              ),
              SizedBox(height: 14.h),
              _CostComposition(
                subscriptionCost: logic.selectedMonthSubCost,
                expenseRecordCost: logic.selectedMonthExpenseRecordCost,
                totalCost: totalCost,
                semantic: semantic,
              ),
