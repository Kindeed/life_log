...
| CCSDS table extraction | started | Table entries captured with source section/page references and tests for selected examples; CCSDS 401, 211.2, 131 B-5, 231, 132, 232, 414.1, 121, and 120.2/123 Green Book have first-pass extracts. |
