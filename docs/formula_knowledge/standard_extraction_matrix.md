...
| CCSDS 211.0/211.1/211.2 Proximity-1 | Proximity frame fields, physical data rates, coding/sync options | proximity mode table, net-rate formula | PROTO-011 to PROTO-026, LINK formulas | CCSDS 211.2-B-3 first-pass coding/sync extraction added PLTU, idle, convolutional, LDPC/CSM, and randomizer formulas; 211.0/211.1 direct extraction remains. |
...
| Sklar / Proakis / Haykin | BER/PER, modulation, coding, synchronization, source coding | digital-comms formula batch | BB-001 to BB-076, COMP, PROTO | Baseband timing/energy, Shannon/Nyquist, pulse shaping, quantization, matched-filter, OFDM, phase-jitter, MIMO, and CCSDS 401 cross-check seeds added; detailed BER tables and synchronization loop procedures remain. |
