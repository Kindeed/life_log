...
| Sklar / Proakis / Haykin | BER/PER, modulation, coding, synchronization, source coding | digital-comms formula batch | BB-001 to BB-081, COMP, PROTO | Baseband timing/energy, Shannon/Nyquist, pulse shaping, quantization, matched-filter, OFDM, phase-jitter, MIMO, CCSDS 401, and Proximity-1 physical-rate cross-check seeds added; detailed BER tables and synchronization loop procedures remain. |
...
| CCSDS table extraction | started | Table entries captured with source section/page references and tests for selected examples; CCSDS 401, 211.2, 131 B-5, 231, 132, 232, and 414.1 have first-pass extracts. |
