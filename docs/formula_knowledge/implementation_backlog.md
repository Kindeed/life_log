...
7. Orbit/contact and RF measurement pass:
   ...
   - Current measurement uncertainty extraction covers JCGM/NIST combined standard uncertainty, independent RSS, expanded uncertainty, Type-A repeatability, small-signal dB uncertainty conversion, Y-factor calibration uncertainty, `G/T`, `N0`, `C/N0`, `Eb/N0`, margin uncertainty, BER/FER point estimates, binomial standard uncertainty, Clopper-Pearson and Wilson confidence intervals, zero-error/allowed-error pass probabilities, test-duration sizing, measured `Eb/N0`/implementation-loss references, NIST SP 1065 phase/time/frequency conversion, fractional frequency, holdover, Allan/overlapping Allan/modified Allan/TDEV/Hadamard/MTIE, clock-driven range/Doppler uncertainty, and phase-noise jitter formulas.
...
6. Tracking/ranging workbench:
   ...
   - phase/time conversion, fractional frequency, holdover time-error margin, Allan deviation, overlapping Allan deviation, modified Allan deviation, TDEV, Hadamard deviation, MTIE, TIE, clock-induced range/Doppler uncertainty, phase-noise jitter, and stability margin
...
7. Optical communications workbench:
   ...
   - CCSDS optical carrier/wavelength, laser linewidth/coherence, OOK slot-rate/duty-cycle, guarded PPM, SCPPM slot efficiency, and optical Reed-Solomon product-code structure cards
   - remaining source work: exact CCSDS 141/142 mode tables, synchronization constants, coded SCPPM/PPM performance tables, optical R-S product-code selected rows, Hufnagel-Valley/CLEAR turbulence profile datasets, P.1814 mid/far-IR coefficient tables, rain/fog CCDF procedure, optical validation examples, and production-ready detector-array optimization tests
...
8. System closure workbench:
   ...
   - solar-array BOL/EOL power, battery required energy, Ah capacity, recharge time, orbit energy margin, DOD margin
   - direct solar/albedo/planet-IR heat loads, radiator heat rejection, required radiator area, heater duty cycle, and hot/cold thermal-limit margin
