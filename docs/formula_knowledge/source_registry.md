...
| CCSDS-131.3 | CCSDS 131.3-B, CCSDS Space Link Protocols over ETSI DVB-S2 Standard | CCSDS SLS-C&S | Active Issue 2, April 2022; maps CCSDS space link protocols onto DVB-S2 and adds USLP support. | MODCOD table extraction, spectral efficiency, BBFRAME/FECFRAME/PLFRAME overhead, pilot overhead, and net-rate calculation. |
...
| CCSDS-141 | CCSDS 141.0-B-2, Non-Coherent Optical Communications Physical Layer | CCSDS SLS-OPT | CCSDS search and active-publication pages list Issue 2, March 2026, covering non-coherent optical physical-layer specifications. First pass records structural wavelength/frequency, linewidth/coherence, OOK slot, and optical power relations; exact parameter tables remain pending. | Non-coherent optical physical-layer calculators, carrier/wavelength conversion, laser-linewidth checks, OOK/slot-rate sizing, and optical peak/average power cards. |
| CCSDS-142 | CCSDS 142.0-B-2, Non-Coherent Optical Communications Coding and Synchronization | CCSDS SLS-OPT | CCSDS search and active-publication pages list Issue 2, March 2026. First pass records guarded PPM and SCPPM-style coding-chain structure; exact modes, code tables, sync markers, and validation vectors remain pending. | Optical coding/synchronization overhead, PPM slot framing, guard slots, symbol repetition, SCPPM efficiency, and later coded optical performance tables. |
| CCSDS-142.10 | CCSDS 142.10-O-1, Reed-Solomon Product Code for Optical Communication | CCSDS SLS-OPT | CCSDS active-publication/search entries and public PDF links identify this Orange Book as the optical RS product-code specification; first pass records rectangular product-code dimensions and rate. | Optical Reed-Solomon product-code block sizing, rate, parity overhead, and block-duration calculators. |
| ETSI-DVBS2 | ETSI EN 302 307-1, Digital Video Broadcasting (DVB); Second generation framing structure, channel coding and modulation systems, Part 1: DVB-S2 | ETSI | Current stable DVB-S2 base standard used by CCSDS 131.3; ETSI lists EN 302 307-1 V1.4.1. | DVB-S2 BBFRAME, BCH/LDPC FECFRAME, PLFRAME, pilots, rolloff bandwidth, MODCOD table fields, and spectral-efficiency formulas. |
...
| DESCANSO-OPTICAL | Hemmati, *Deep Space Optical Communications* | NASA/JPL DESCANSO | Public DESCANSO series monograph, October 2005; extracts added for optical link, photon counting, PPM, Poisson detection, acquisition beacon sizing, sky/background power, atmospheric seeing, Fried parameter, and focal-plane detector-array selection. | Optical link budget, photon-counting receivers, PPM timing/efficiency, Poisson BER/SER, detector background/dark-count terms, beacon pointing/acquisition support, atmospheric optical turbulence, seeing-limited FOV, and detector-array combining. |
...
| BOOK-BALANIS | Balanis, *Antenna Theory: Analysis and Design*, 4th ed. | Wiley page and companion site identify the 4th edition and antenna-theory chapter/resource structure. | Antenna gain, effective aperture, beamwidth, polarization, reflector/dish sizing, directivity, beam solid angle, far-field distance, array fundamentals, aperture-field pattern integration, taper concepts, mutual impedance/coupling context, and antenna measurement formulas. |
| BOOK-MAILLOUX | Mailloux, *Phased Array Antenna Handbook*, 3rd ed. | Artech House publication page identifies the phased-array handbook and edition. | Electronically scanned array steering, grating lobes, scan loss, phase quantization, beam squint, taper synthesis, active reflection/VSWR, and array implementation checks. |
...
| BOOK-VALLADO | Vallado, *Fundamentals of Astrodynamics and Applications* | Microcosm/AIAA/CelesTrak publisher and support pages identify the astrodynamics reference and source-code material. | Orbit geometry, ground-station look angles, visibility, range/range-rate support, J2 secular effects, repeat ground tracks, Kepler propagation, access-event semantics, and basic maneuver formulas. |
| BOOK-BATE | Bate, Mueller, White, *Fundamentals of Astrodynamics* | Dover/Google Books bibliographic pages identify the published astrodynamics textbook. | Classical orbit mechanics, Kepler propagation, impulsive maneuvers, and contact geometry sanity checks. |
...
5. Continue orbit/contact/system extraction from Vallado/SMAD/Bate and public coordinate references: exact time-scale handling, EOP corrections, SGP4/TLE integration, repeat-ground-track search examples, and contact-window validation examples.
...
| CCSDS optical search | https://ccsds.org/searchpubs/ |
| CCSDS SLS publications | https://ccsds.org/view/sls/ |
| CCSDS-142.10 PDF | https://public.ccsds.org/Pubs/142x10o1e1.pdf |
| ETSI-DVBS2 | https://www.etsi.org/deliver/etsi_en/302300_302399/30230701/01.04.01_60/en_30230701v010401p.pdf |
| ETSI DVB-S/S2 overview | https://www.etsi.org/technologies/dvb-s-s2 |
