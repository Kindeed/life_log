...
| Link budget | FSPL, C/N0, Eb/N0, Es/N0, margin, inverse sizing | ITU-R P.525, DSN 810-005, Maral/Bousquet | Partly implemented and seeded | Add uplink/downlink/relay multi-hop budget and transponder saturation/backoff. |
...
| Ranging/tracking | PN range, ambiguity, Doppler, guard band, Delta-DOR, radar equation | CCSDS 414.1, 415, DSN 810-005, Balanis | Partly implemented and seeded | Extract transparent/regenerative PN modes, chip-rate tables, D-DOR error model, sequential ranging if public sources permit. |
...
As of this pass, `formula_catalog.md` contains over 160 formula or formula-family entries across RF, link, baseband, telemetry, telecommand, ranging/tracking, system, optical, orbit/contact, compression, protocol, and measurement domains.
